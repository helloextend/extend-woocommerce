...
class ContractController {
  ...
  private getCustomer(blob: any) {
    ...
    if (!customerMutableObject.email) {
      ...
      return {
        error: '[Index.ts getCustomer]: Could not extract EMAIL from customer information.',
      } as InformativeError;
    }
