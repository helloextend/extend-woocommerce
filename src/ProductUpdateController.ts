...
class ProductUpdateController {
    updateProducts() {
        ...
        request(options2, function (error: any, response: any) { 
            ...
            // NOTE: Verify this implementation works. 
            /*

            for (var m of myMap.keys()) is incorrect. I changed it
            to make it TS complient. Please make sure there are no adverse effects
            
            */

            for (var m in myMap.keys()) {
            console.log("Deleting" + myMap.get(m));
            var options5 = {
                'method': 'DELETE',
